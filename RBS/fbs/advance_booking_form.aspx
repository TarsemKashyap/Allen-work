<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false"  validaterequest="false" inherits="advance_booking_form, fbs" %>
...
<head>
    ...
    <script type="text/javascript">
        function close() {
            window.top.location.href = "bookings.aspx";
            //location.href = "bookings.aspx";
        }
        function ClientItemSelected(sender, e) {
            $get("<%=hfUserId.ClientID %>").value = e.get_value();
            var id = e.get_value();
            var acc = '<%=current_user.account_id %>';
    ...
    <form id="form1" runat="server">
            <div class="p-c">
                ...
                <div class="c-f">
                    ...
                    <div class="rfl">
                        <div class="s12">
                            <h3 class="pt-header">Booking Details
                            </h3>
                        </div>
                    </div>
                                    ...
                                    <div class="tabbable  tabbable-custom boxless nav-justified">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_default">
                                                ...
                                                <asp:HiddenField ID="hdn_unique_id" runat="server" />
                                                <table width="100%">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="controls chzn-controls">
                                                                ...
                                                                <asp:TextBox ID="txtBookedFor" runat="server" CssClass="mw span10" data-placeholder="Choose booked for" onkeyup="SetContextKey()"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        <td style="width: 180px;">
                                                            <div runat="server" id="div_setup_type">
                                                                <label class="cl">
                                                                    Setup Type<span class="required">*</span></label>
                                                            </div>
                                                        </td>
                                                        <td>
...
<%--                                                    <tr>
                                    ...
                                    <div class="fa ">
                                                                <asp:Button ID="btn_submit" CssClass="btn green" runat="server" Text="Save Booking"
                                                                    OnClick="btn_submit_Click" ValidationGroup="email_group" OnClientClick="return show_loading();" />
