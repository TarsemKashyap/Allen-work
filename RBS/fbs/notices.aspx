<%@ page title="" language="C#" masterpagefile="~/fbs.master" autoeventwireup="true" inherits="notices, fbs" %>
            ...
            <div class="pbd">
                <div class="table-toolbar">
                    <div class="controls">
                        ...
                        <asp:Button runat="server" ID="btn_filter" Text="Filter" CssClass="btn green" 
