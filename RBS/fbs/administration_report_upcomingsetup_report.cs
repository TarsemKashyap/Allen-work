...
// Type: administration_report_upcomingsetup_report
...
public class administration_report_upcomingsetup_report : fbs_base_page, IRequiresSessionState
{
  ...
  protected void Talbe_Header()
  {
    ...
    stringBuilder.Append("<table class='table table-striped table-bordered table-hover' id='setup_table'>");
  ...
  protected void pageload_Data(string Fromdate, string Todate)
  {
    try
    {
      ...
      DataSet unassignedData = this.reportings.getUnassignedData("Setup", Fromdate, Todate, groupids, this.current_user.account_id);
  ...
  protected void btnExportExcel_Click(object sender, EventArgs e)
  {
    ...
    {
      string groupids = this.gp.isAdminType ? "" : "asset_owner_group_id IN (" + string.Join(",", this.gp.group_ids.ToArray()) + ") AND ";
      DataSet ds = !(this.hdn_original_end.Value != "") || !(this.hdn_original_start.Value != "") ? this.reportings.getUnassignedData("Setup", DateTime.Today.ToString(api_constants.sql_datetime_format_short) + " 00:00:00 AM", DateTime.Today.ToString(api_constants.sql_datetime_format_short) + " 23:59:59 PM", groupids, this.current_user.account_id) : this.reportings.getUnassignedData("Setup", this.hdn_original_start.Value + " 00:00:00 AM", this.hdn_original_end.Value + " 23:59:59 PM", groupids, this.current_user.account_id);
      if (ds != null)
      {
      ...
      if (ds == null)
        return;
      this.Response.Clear();
      this.Response.AddHeader("content-disposition", "attachment;filename=ManpowerReport_" + this.current_timestamp.ToString(api_constants.display_datetime_format) + ".xls");
      ...
      stringBuilder.Append("<tbody>");
      stringBuilder.Append("<tr>");
      stringBuilder.Append("<th style='font-size:x-large;'>Manpower Report List</th>");
      ...
      stringBuilder.Append("<th>Contact</th>");
