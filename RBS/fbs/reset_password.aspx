<%@ page language="C#" autoeventwireup="true" inherits="reset_password, fbs" %>
            ...
            <div id='d_ou'>
                <div id="d_o_i">
                    ...
                    <div class="cg">
                        ...
                        <label class="cl">Current Password<span class="required">*</span><span id="errorCurrentPassword" class="requiredField"></span></label>
                        <div class="controls">
                    ...
                    <div class="cg">
                        <label class="cl">New Password<span class="required">*</span> <span id="errorPassword" class="requiredField"></span></label>
                        <div class="controls">
                            <div class="in-ic left">
                    ...
                    <div class="cg">
                        <label class="cl">Repeat Password<span class="required">*</span> <span id="error2Password" class="requiredField"></span></label>
                        <div class="controls">
                            <div class="in-ic left">
