...
// Type: administration_hotdesk_dashboard
...
public class administration_hotdesk_dashboard : fbs_base_page, IRequiresSessionState
{
  ...
  private hotdesk_dashboard_api dapi;
  ...
  {
    this.dapi = new hotdesk_dashboard_api();
