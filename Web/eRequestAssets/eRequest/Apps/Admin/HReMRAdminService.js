"use strict";
(function () {
    app.factory("HReMRAdminService", ["baseSvc", "Config", "$http", "$q", function (baseService, Config, $http, $q) {
        ...
        var getMasterDataWithLookupColumn = function (Listname,ColumnName) {
            var query = listEndPoint + "/GetByTitle('" + Listname + "')/Items?$top=100&$orderby=Modified desc&$select=*"
        ...
        var getClosedRequestsWithAppStatus = function (aprvdstatus, RejectedStatus) {
            var query = listEndPoint + "/GetByTitle('" + Config.HRRequests + "')/Items?$filter=((ApplicationStatus eq " + aprvdstatus + ") or (ApplicationStatus eq " + RejectedStatus + "))&$top=100&$orderby=Modified desc&$select=*"
        ...
        var getOngoingRequestsWithAppStatus = function (appstatus) {
            var query = listEndPoint + "/GetByTitle('" + Config.HRRequests + "')/Items?$filter=(ApplicationStatus eq " + appstatus + ") &$top=100&$orderby=Modified desc&$select=*"
                + ",Requestor/Id,Requestor/EMail,Requestor/Title,Requestor/Name"
                + ",RequestedFor/Id,RequestedFor/EMail,RequestedFor/Title,Requestor/Name"
                + ",ManpowerRequestType"
                + ",ManpowerType"
       ...
       // get all SystemAccess data
        var getAllSysRequests = function () {
            var query = listEndPoint + "/GetByTitle('" + Config.HRRequests + "')/Items?$top=100&$orderby=Modified desc&$select=*"
                + ",Requestor/Id,Requestor/EMail,Requestor/Title,Requestor/Name"
                + ",RequestedFor/Id,RequestedFor/EMail,RequestedFor/Title,Requestor/Name"
                + ",ManpowerRequestType"
                + ",ManpowerType"
        ...
        var getAllRequestorSysRequests = function (userId) {
            var query = listEndPoint + "/GetByTitle('" + Config.HRRequests + "')/Items?$filter=Author/Id eq " + userId + "&$top=100&$orderby=Modified desc&$select=*"
                + ",Requestor/Id,Requestor/EMail,Requestor/Title,Requestor/Name"
                + ",RequestedFor/Id,RequestedFor/EMail,RequestedFor/Title,Requestor/Name"
                + ",ManpowerRequestType"
                + ",ManpowerType"
        ...
        var getAuthorization = function () {
            var query = listEndPoint + "/GetByTitle('" + Config.HRRequestsApprovers + "')/Items?$top=1000&$orderby=Modified desc&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",SystemAccessHead/Id,SystemAccessHead/EMail,SystemAccessHead/Title"
                + ",ImplementationOfficer/Id,ImplementationOfficer/EMail,ImplementationOfficer/Title"
        ...
        var getCommentsById = function (listItemId) {
            var query = listEndPoint + "/GetByTitle('" + Config.HRRequestsComments + "')/items?$filter=ITRequestsID eq " + listItemId + "&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
