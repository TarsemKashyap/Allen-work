"use strict";
(function () {
    app.factory("CRSRAdminDashboardService", ["baseSvc", "Config", "$http", "$q", function (baseService, Config, $http, $q) {
        ...
        var getOngoingCRSRRequests = function (appstatus) {
            var query = listEndPoint + "/GetByTitle('" + Config.CRSR + "')/Items?$filter=(ApplicationStatus eq " + appstatus + ")&$top=100&$orderby=Modified desc&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",RequestedFor/Id,RequestedFor/EMail,RequestedFor/Title"
                + ",BranchHead/Id,BranchHead/EMail,BranchHead/Title"
        ...
        var getClosedCRSRRequests = function (aprvdstatus, RejectedStatus) {
            var query = listEndPoint + "/GetByTitle('" + Config.CRSR + "')/Items?$filter=((ApplicationStatus eq " + aprvdstatus + ") or (ApplicationStatus eq " + RejectedStatus + "))&$top=100&$orderby=Modified desc&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",RequestedFor/Id,RequestedFor/EMail,RequestedFor/Title"
                + ",BranchHead/Id,BranchHead/EMail,BranchHead/Title"
