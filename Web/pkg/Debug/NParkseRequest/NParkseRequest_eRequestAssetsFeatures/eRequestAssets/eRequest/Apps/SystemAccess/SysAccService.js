"use strict";
(function () {
    app.factory("SysAccService", ["baseSvc", "Config", "$http", "$q", function (baseService, Config, $http, $q) {
       ...
       // get all SystemAccess data
        ...
        // get getAllRequestor data based on createdby
        ...
        var getPendingSysRequests = function (userId,CurrrentUserStatus) {
            var query = listEndPoint + "/GetByTitle('" + Config.SystemAccess + "')/Items?$filter=" + CurrentUserDept + "/Id eq " + userId + " and (BranchHead eq '" + CurrrentUserStatus + "')&$top=1000&$orderby=Modified desc&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",RequestedFor/Id,RequestedFor/EMail,RequestedFor/Title"
                + ",BranchHead/Id,BranchHead/EMail,BranchHead/Title"
        ...
        // get Pending getPendingSysRequests data
        var getPendingSysRequests = function (CurrentUserStatusFiled, CurrrentUserStatus, CurrrentUserPPLPickerName, userId) {
            var query = listEndPoint + "/GetByTitle('" + Config.ITRequests + "')/Items?$filter=(" + CurrentUserStatusFiled + " eq '" + CurrrentUserStatus + "') and (" + CurrrentUserPPLPickerName + "/Id eq " + userId + ")&$top=1000&$orderby=Modified desc&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",RequestedFor/Id,RequestedFor/EMail,RequestedFor/Title"
                + ",BranchHead/Id,BranchHead/EMail,BranchHead/Title"
        ...
        //getNextApprover
        var getNextLevelApprover = function (ListName, systemacessCode, workFlowcode) {
            var query = listEndPoint + "/GetByTitle('" + ListName + "')/items?$filter=(SystemAccessCode eq '" + systemacessCode + "') and (WorkFlowCode eq '" + workFlowcode +"')'&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",SystemAccessHead/Id,SystemAccessHead/EMail,SystemAccessHead/Title"
                + ",ImplementationOfficer/Id,ImplementationOfficer/EMail,ImplementationOfficer/Title"
        ...
        //getNextApprover
        var getEveModuleApprover = function (ListName, ModuleName) {
            var query = listEndPoint + "/GetByTitle('" + ListName + "')/items?$filter=(Title eq '" + ModuleName + "')'&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",EVEModuleOwner/Id,EVEModuleOwner/EMail,EVEModuleOwner/Title"
                + ",EVEModuleLeader/Id,EVEModuleLeader/EMail,EVEModuleLeader/Title"
        ...
        //getNextApprover
        var getACEModuleApprover = function (ListName, ModuleName) {
            var query = listEndPoint + "/GetByTitle('" + ListName + "')/items?$filter=(Title eq '" + ModuleName + "')'&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",ACEModuleOwner/Id,ACEModuleOwner/EMail,ACEModuleOwner/Title"
                + ",ACEModuleLeader/Id,ACEModuleLeader/EMail,ACEModuleLeader/Title"
                + ",ACEImplementationOfficer/Id,ACEImplementationOfficer/EMail,ACEImplementationOfficer/Title"
                + "&$expand=Author/Id,Editor/Id,ACEModuleOwner/Id,ACEModuleLeader/Id,ACEImplementationOfficer/Id" //expend for peoplepciker         
            return baseService.getRequest(query);
        };
        var getACEModuleMaster = function (ListName ) {
            var query = listEndPoint + "/GetByTitle('" + ListName + "')/items?$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + ",ACEModuleOwner/Id,ACEModuleOwner/EMail,ACEModuleOwner/Title"
                + ",ACEModuleLeader/Id,ACEModuleLeader/EMail,ACEModuleLeader/Title"
        ...
        //get System access by id
        var getsubListItemByParentId = function (ListName,columnName, listItemId) {
            var query = listEndPoint + "/GetByTitle('" + ListName + "')/items?$filter=" + columnName+" eq " + listItemId + "&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
                + ",Editor/Id,Editor/EMail,Editor/Title"
                + "&$expand=Author/Id,Editor/Id" //expend for peoplepciker
            return baseService.getRequestAll(query);
        ...
        var getAllMasterListDataLookup = function (ListName) {
            var query = listEndPoint + "/GetByTitle('" + ListName + "')/Items?$top=1000&$orderby=Title desc&$select=*"
                + ",System/Id,System/Title"
                + "&$expand=System/Id" //expend for peoplepickr    
            return baseService.getRequest(query);
        };
         //masterlist
        ...
        var getCommentsById = function (listItemId) {
            var query = listEndPoint + "/GetByTitle('" + Config.SystemAccessComments + "')/items?$filter=SysAccessListItemID eq " + listItemId + "&$select=*"
                + ",Author/Id,Author/EMail,Author/Title"
        ...
        return {
            getAll: getAll,
            getAllReq: getAllReq,
            getsubListItemByParentId: getsubListItemByParentId,
            getAllMasterListDataLookup: getAllMasterListDataLookup,
            ...
            getACEModuleApprover: getACEModuleApprover,
            getById: getById,
            ...
            getACEModuleMaster: getACEModuleMaster,
