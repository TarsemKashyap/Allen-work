...
(function () {
    app.controller("SysAccRequestController", ["$scope", "SysAccService", "CommonService", "Config", "$location", "$window", "$uibModal", "$filter", "$timeout", function ($scope, uService, commonService, Config, $location, $window, $uibModal, $filter, $timeout) {
        ...
        function getHtMLContent() {
            ...
            str += '<tr><td>Type Of Request: </td><td>dsfdsfsf</td></tr>';
            str += '<tr><td>Effective Date : </td><td>dsfdsfsf</td></tr';
            ...
            str += '<tr><td>Supervisor/ Authorised Personnel Email: </td><td>dsfdsfsf</td></tr>';
            str += '<tr><td>VIP  : </td><td>No</td></tr> ';
            str += ' <tr><td>Indicate VIP designation: </td><td>XXX</td></tr>';
            
            str += '<tr><td style="height:20px;" colspan="2"><b><u>Authorisation Request Details</u></b></td></tr>';
            str += '<tr><td>User Type : </td><td>dsfdsfsf</td></tr>';
            str += '<tr><td>Others (if-any): </td><td>dsfdsfsf</td></tr>';
            str += '<tr><td>Reason For Reques: </td><td>dsfdsfsf</td></tr>';
            str += ' <tr><td style="height:20px;" colspan="2"><b><u>Details Of Requestor</u></b></td></tr>';
            str += '<tr><td>Name : </td><td>NPARKS</td></tr>';
            str += '<tr><td>Designation : </td><td>dsfdsfsf</td></tr>';
            str += '<tr><td>Email Address: </td><td>dsfdsfsf</td></tr>';
            str += '<tr><td>Telephone No: </td><td>dsfdsfsf</td></tr>';
            str += ' <tr><td>Date : </td><td>dsfdsfsf</td></tr>';
            str += '<tr><td style="height:20px;" colspan="2"><b><u>Authorised By</u></b></td></tr>';
            str += '<tr><td>User ID: </td><td>dsfdsfsf</td></tr>';
            str += ' <tr><td>Date : </td><td>dsfdsfsf</td></tr>';
            ...
            str += '<td>NParks</td>';
            str += '<td>F&P</td>';
            str += '<td>Z-XXXXX-PO_CREATOR</td>';
            str += '<td>Purchase order creator</td';
            str += '<td>N1233,N15XX</td>';
            str += ' </tr>';
            str += '</tbody>';
            str += '</table>';
